...
all_bus_filepath = "collapsed_business_end.txt"#"collapsed_business_rest_subset.txt"
...
# In[ ]:
with codecs.open('output_file_test_minimal_codecs_substr_b.txt', 'a', encoding='utf_8') as out_file:

	with codecs.open(all_bus_filepath, encoding='utf_8') as review_file:
